...
output: 
  rmdformats::readthedown:
    css: custom.css
bibliography: tfr_references.bib
---
...
First we load the tidyverse() library of R packages [@tidyverse], which includes the ggplot2() package [@ggplot2], the dplyr() package [@dplyr], and the plotly() package [@plotly]. We also use the ggthemes() package for cool styling later [@ggthemes] and the gt() package for outputting html tables [@gt].
