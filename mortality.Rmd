...
decomp_long = decomposition %>%
  pivot_longer(cols = starts_with("Contribution"), names_to = "Contribution_Type", values_to = "Value") %>%
  mutate(Contribution_Type = factor(Contribution_Type, levels = c("Contribution_Age_Dist", "Contribution_Death_Rate")))

p = ggplot(decomp_long, aes(x = Age, y = Value, fill = Contribution_Type)) +
  geom_bar(stat = "identity", position = "stack") +
  scale_fill_manual(values = c("Contribution_Age_Dist" = "lightblue", "Contribution_Death_Rate" = "lightgreen")) +
  labs(x = "Age Group",
       y = "Contribution",
